...
unsafe fn grouped_conv1d_direct_avx2(
    ...
    for b in 0..batch_size {
        ...
        for group in 0..layer.groups {
            let input_group_base =
                group * group_in;

            let output_group_base =
                group * group_out;
...
///
/// Parameter data is supplied directly as contiguous slices.
/// There is no Tensor/handle lookup or tape access.
